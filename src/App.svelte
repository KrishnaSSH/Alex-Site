...
<main>
  ...
  <h2>Alex</h2>
  <h1>A multipurpose Ai discord bot</h1>

  <div class="sp">
    <a href="https://discord.com/oauth2/authorize?client_id=1236903163869663273&permissions=8&scope=bot">
    <button class="sparkle-button">
      ...
      <span class="text">Invite me</span>
    </button>
    </a>
...
*{
  ...
  .logo:hover {
    filter: drop-shadow(0 0 2em #2db234aa);
  }
